...
# Versión 2.1 - CORREGIDA para evitar bloqueos en bandeja del sistema
...
exe = EXE(
    ...
    a.datas,
    [],
    name='SincronizadorBiometricoV2.1_Fixed',
    debug=False,
    ...
    upx_exclude=[],
    runtime_tmpdir=None,
    console=True,  # CAMBIO: Temporalmente habilitamos consola para debugging
    ...
    version_info={
        'version': '2.1.1.0',
        'description': 'Sincronizador Biométrico V2.1 - Versión corregida sin bloqueos',
        'product_name': 'SincronizadorBiometricoV2.1_Fixed',
        'file_description': 'Sincronizador Biométrico V2.1 Corregido',
        'company_name': 'Entrecables y Redes',
        'copyright': '© 2025 Entrecables y Redes',
        'internal_name': 'SincronizadorBiometricoV2.1_Fixed'
    }
)
