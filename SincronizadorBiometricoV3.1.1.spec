...
# Configuración para SincronizadorBiometrico V3.1.1
# Versión 3.1.1 - Corrección completa de inicio automático con Windows + UI threading mejorado
...
exe = EXE(
    ...
    a.datas,
    [],
    name='SincronizadorBiometricoV3.1.1',
    debug=False,
    ...
    version_info={
        'version': '3.1.1.0',
        'description': 'Sincronizador Biométrico V3.1.1 - Inicio automático Windows 100% funcional',
        'product_name': 'SincronizadorBiometricoV3.1.1',
        'file_description': 'Sincronizador Biométrico V3.1.1 - Threading + Windows Startup corregido',
        'company_name': 'Entrecables y Redes',
        'copyright': '© 2025 Entrecables y Redes',
        'internal_name': 'SincronizadorBiometricoV3.1.1'
    }
)