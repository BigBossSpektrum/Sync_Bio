...
# Versión corregida para evitar bloqueos del ejecutable
...
exe = EXE(
    ...
    a.datas,
    [],
    name='SincronizadorBiometricoV2_Fixed',
    debug=False,
    ...
    version_info={
        'version': '2.1.0.0',
        'description': 'Sincronizador Biométrico V2.1 - Versión optimizada sin bloqueos',
        'product_name': 'SincronizadorBiometricoV2_Fixed',
        'file_description': 'Sincronizador Biométrico V2.1 Optimizado',
        'company_name': 'Entrecables y Redes',
        'copyright': '© 2025 Entrecables y Redes',
        'internal_name': 'SincronizadorBiometricoV2_Fixed'
    }
)
