...
# Configuración FINAL para SincronizadorBiometrico V2.1
# Versión 2.1 - SIN CONSOLA - Optimizada para evitar bloqueos
...
exe = EXE(
    ...
    a.datas,
    [],
    name='SincronizadorBiometricoV2.1_Final',
    debug=False,
    ...
    version_info={
        'version': '2.1.2.0',
        'description': 'Sincronizador Biométrico V2.1 - Versión final optimizada',
        'product_name': 'SincronizadorBiometricoV2.1_Final',
        'file_description': 'Sincronizador Biométrico V2.1 Final',
        'company_name': 'Entrecables y Redes',
        'copyright': '© 2025 Entrecables y Redes',
        'internal_name': 'SincronizadorBiometricoV2.1_Final'
    }
)
